...
class Funcoes():
    ...
    def deleta_cliente(self):
        ...
        self.db_conect()
        self.cursor.execute(
            """DELETE FROM clientes WHERE id = ?""", (self.codigo))
        self.conexao.commit()
        self.db_desconect()
        self.limpar_campos()
        self.select_lista()
    ...
    def Buscar_Cliente(self):
        ...
        self.cursor.execute(
            """SELECT * FROM clientes WHERE Nome LIKE '%s' COLLATE NOCASE ORDER BY Nome ASC""" % nome)
...
class Aplication(Funcoes, Relatorios):
    ...
    def Menus(self):
        ...
        filemenu2.add_command(label="Limpar campos",
